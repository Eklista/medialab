...
Revision ID: eec2e744e9ef
Revises: 
Create Date: 2025-05-05 16:55:09.246196
...
def upgrade():
    ...
    op.create_index(op.f('ix_department_types_id'), 'department_types', ['id'], unique=False)
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['type_id'], ['department_types.id'], ),
    sa.PrimaryKeyConstraint('id'),
...
def downgrade():
    ...
    op.drop_index(op.f('ix_department_types_id'), table_name='department_types')
